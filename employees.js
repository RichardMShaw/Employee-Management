...
db.query(`
  SELECT employees.id, employees.firstName, employees.lastName, roles.tile, roles.salary,
  departments.name AS department, CONCAT(manager.firstName, ' ', manager.lastName) AS manager
